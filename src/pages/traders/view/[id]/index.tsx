...
import { getTraderById } from 'apiSdk/traders';
import { TraderInterface } from 'interfaces/trader';
import { JournalEntryListPage } from 'pages/journal-entries';
import { SimulationListPage } from 'pages/simulations';

function TraderViewPage() {
